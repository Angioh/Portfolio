function AboutMe() {
  return (
    <section className="px-4 py-12" id="aboutme">
      <div id="container" className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2">
        <div id="box1" className="pr-5  basis-50 p-4">
          ...
          <p>
            ...
            cara al público donde aprendí a resolver problemas bajo presión —
            algo que hoy traslado directamente a depurar código y priorizar
            tareas.
          </p>
        </div>
